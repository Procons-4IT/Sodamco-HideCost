                    ...
                    Case False
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_FORM_LOAD
                                ...
                                '    If oUser.UserFields.Fields.Item("U_HidAmtRP").Value = "Y" Then
                                '        initializeControls(oForm)
                                '        enableControls(oForm, False)
                                '    End If
                                'End If
...
#Region "Function"
    ...
    Private Sub initializeControls(ByVal oForm As SAPbouiCOM.Form)
        Try
            ...
            oForm.Items.Item("22").Width = 1
            oForm.Items.Item("24").Width = 1
            oForm.Items.Item("42").Width = 1
            oForm.Items.Item("89").Width = 1
            oForm.Items.Item("103").Width = 1
            oForm.Items.Item("27").Width = 1
            oForm.Items.Item("29").Width = 1
