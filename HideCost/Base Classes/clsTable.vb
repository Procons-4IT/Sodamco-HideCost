...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        Try
            ...
            addField("OUSR", "HideAmt", "GRPO - Hide Amount", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            addField("OUSR", "HidAmtPO", "Purchase - Hide Amount", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            addField("OUSR", "HidAmtRP", "Pur Return - Hide Amount", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            addField("OUSR", "HidAmtPR", "Production - Hide Amount", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
